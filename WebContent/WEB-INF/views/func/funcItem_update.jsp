	...
	<form id="form1" action="">
		<div style="margin-top: 5%;">
			...
			<div class="input-box">
				...
				<input type="text"  name="funcName" class="input" value="${resultObject.funcName }" />
				<span class="error-text" id="error"></span>
			</div>
			<div class="input-box">
					<label for="funcSort" class="label">排序号：</label>
					<input type="text" name="funcSort" class="input" value="${resultObject.funcSort }"/>
					<span class="error-text" id="error"></span>
			</div>
			<div class="input-box">
...
$(function(){
	$("#form1").validate({
		...
		submitHandler:function(form){
			CommonAjaxJson(
					'${pageContext.request.contextPath}/funcItem/updateFuncItem',
					 $("#form1").serialize(), 
					 function(data){
